...
/**
 * See http://www.khronos.org/registry/webgl/specs/latest/ for details 
 */


/* TODO: ADD VAO support for 
 ...
 * TODO: For some fucking reason Typescript gave some identifier issue if this interface was not exported
 */
...
/**
 *  the parent interface for all GL objects
 */ 
...
/**
 * NOTE: this contains functions for VertexArrayObjects. 
 * These are only avail in WebGL1 with the OES_vertex_array_object extension. 
 */
interface WebGLRenderingContext
{
	...
	/* set framebuffer to null to render to the canvas */
	...
	/* Only avail in WebGL1 with the OES_vertex_array_object extension */
    ...
    /**
     * 
     * @param target The target texture, which must be either GL_TEXTURE_1D or GL_TEXTURE_2D.
     * @param pname The symbolic name of a single valued texture parameter you want to set. Can be: 
     ...
     *                                    Vals either GL_NEAREST or GL_LINEAR.
     *              GL_TEXTURE_WRAP_S
     *              GL_TEXTURE_WRAP_T
     * 
     * @param param The value of pname.
     */
